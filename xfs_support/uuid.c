...
#include <xfs_support/uuid.h>
#include <xfs_support/mutex.h>
#include <xfs_support/arch.h>
#include <xfs_support/time.h>
 ...
 */
#define	UUID_TBC	(__int64)0x01B21DD2138140
...
uuid_create(uuid_t *uuid)
{
	...
	if (!uuid_is_init) {
		 ...
		 */
		uuid_time = ts.tv_sec * (__int64)10000000 +
			    ts.tv_nsec / 100 +
			    UUID_TBC;
		uuid_is_init = 1;
	}
	...
	uuid_time++;
	uu->uu_timelow = (u_int32_t)(uuid_time & 0x00000000ffffffff);
