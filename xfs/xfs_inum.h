...
#else
#define	XFS_INO_MASK(k)	((__uint32_t)(((__u64)1 << (k)) - 1))
#endif
...
#if XFS_BIG_FILESYSTEMS
#define	XFS_MAXINUMBER		((xfs_ino_t)(((__u64)1 << 56) - (__u64)1))
#define	XFS_INO64_OFFSET	((xfs_ino_t)((__u64)1 << 32))
#else
#define	XFS_MAXINUMBER		((xfs_ino_t)(((__u64)1 << 32) - (__u64)1))
#endif
#define	XFS_MAXINUMBER_32	((xfs_ino_t)(((__u64)1 << 32) - (__u64)1))
