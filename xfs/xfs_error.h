...
#define		XFS_PTAG_IFLUSH			0x0000000000000001
#define 	XFS_PTAG_LOGRES			0x0000000000000002
#define 	XFS_PTAG_AILDELETE		0x0000000000000004

struct xfs_mount;
/* PRINTFLIKE4 */
void CDECL	xfs_cmn_err(uint64_t panic_tag, int level, struct xfs_mount *mp,
			    char *fmt, ...);
/* PRINTFLIKE3 */
void CDECL	xfs_fs_cmn_err(int level, struct xfs_mount *mp, char *fmt, ...);
void CDECL	prdev(char *fmt, dev_t dev, ...);
