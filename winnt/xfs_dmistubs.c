...
int	dm_data_event (void) { return nopkg(); }
int	dm_namesp_event (void) { return nopkg(); }
...
int
dm_send_mount_event(vfs_t *vfsp, dm_right_t vfsp_right, bhv_desc_t *bdp,
...
int
dm_vp_to_handle (vnode_t *vp, xfs_handle_t *handlep)
{
	return nopkg();
}
